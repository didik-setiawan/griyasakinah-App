                        ...
                        <tbody>
                            <?php $i = 1; foreach($list_data as $p){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($p->status == 1){ ?>
                                          <button class="btn btn-xs btn-success check" data-id="<?= $p->id_pembebasan ?>"><i class="fa fa-check"></i></button>
                                          <button class="btn btn-xs btn-danger tolak" data-id="<?= $p->id_pembebasan ?>"><i class="fa fa-times"></i></button>
                                        <?php } else if($p->status == 2){ ?>
