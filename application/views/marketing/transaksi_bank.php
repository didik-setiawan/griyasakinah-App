...
<section class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1>Management Transaksi Bank</h1>
        </div>
    </div>
    </div><!-- /.container-fluid -->
</section>
                    ...
                    <div class="card-body">
                        <nav>
                            ...
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Tambah Transaksi Bank</a>
                                <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">List Transaksi Bank</a>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="<?php access(); ?>">
                                                        <button class="btn btn-xs btn-info add-btn-tf-bank" data-toggle="modal" data-target="#sitemapModal" data-id="<?= $c->id_marketing ?>"><i class="fa fa-plus"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                            ...
                            <table class="table table-bordered mt-3" id="list_tf_bank">
                                    <thead>
                                        <tr class="bg-dark text-light">
                                            <th>#</th>
                                            <th>Nama</th>
                                    ...
                                    <tbody id="list-add-transaksi-bank">
                                        <?php $i = 1; foreach($konsumen_tf_bank as $b){ ?>
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- <div class="<?php access(); ?>"> -->
                                                        <button class="btn btn-xs btn-success view-tf-bank" data-toggle="modal" data-target="#m-tf-bnk" data-konsumen="<?= $b->id_marketing ?>"><i class="fas fa-search"></i></button>
                                                    <?php 
                                                       if($user == 1){
                                                    ?>
                                                        <button class="btn btn-xs btn-warning btn-edit-konsumen <?php access(); ?>" data-toggle="modal" data-id="<?= $b->id_marketing ?>" data-target="#modal-edit"><i class="fa fa-edit"></i></button>
                                                    <?php } ?>
                                                    <!-- </div> -->
                                                </td>
                                            </tr>
...
<!-- Modal add transaksi bank-->
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title text-light" id="staticBackdropLabel">Tambah ke Transaksi Bank</h5>
        <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <span><b class="text-danger">*</b>Lengkapi Data Konsumen</span>
    ...
    <div class="formPasangan d-none">
        ...
        <span><b class="text-danger">*</b>Pilih Rumah</span>
        <div class="row">
            <div class="col-lg-4">
                <label>Pilih Cluster</label>
                <select class="form-control" name="cluster" id="cluster" disabled
                    <?php
                        $status = $this->db->get_where('tbl_perumahan',['id_perumahan' => $this->session->userdata('id_perumahan')])->row()->cluster;
                        if($status == 0){
                    ?>
                        disabled
                    <?php } ?>
            ...
            <input type="hidden" name="status_perum" id="status_perum" value="<?= $status; ?>">
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Pilih Blok</label>
                    <select name="blok" id="blok" class="form-control" disabled>
                        <?php if($status == 1){ ?>
                            <option value="">--pilih--</option>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Type</label>
                    <input type="text" name="type" id="type" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="harga_A" id="harga_A" disabled class="form-control">
                    <input type="text" hidden name="harga" id="harga" class="form-control">
                </div>
            </div>
        </div>
        <span><b class="text-danger">*</b>Pembayaran</span>
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Harga Kesepakatan (Rp)</label>
                    <input type="text" name="v_hk" id="v_hk" class="form-control">
                    <input type="text" hidden name="harga_kesepakatan" id="harga_kesepakatan" class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="tanda_jadi" hidden id="tanda_jadi" class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Tanggal Tanda Jadi</label>
                    <input type="date" name="tgl_tanda_jadi" id="tgl_tanda_jadi" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="v_tanda_jadi_lokasi" id="v_tanda_jadi_lokasi" class="form-control">
                    <input type="text" hidden name="tanda_jadi_lokasi" id="tanda_jadi_lokasi" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_tj" id="angsur_tj" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_angsur_tj" id="v_cicil_angsur_tj" disabled class="form-control">
                    <input type="text" hidden name="cicil_angsur_tj" id="cicil_angsur_tj" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_tj" id="tempo_tj" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="uang_muka" hidden id="uang_muka" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_um" id="v_cicil_um" disabled class="form-control">
                    <input type="text" name="cicil_angsur_um" hidden id="cicil_angsur_um" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_um" id="tempo_um" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="v_kelebihan_tanah" id="v_kelebihan_tanah" class="form-control">
                    <input type="text" name="kelebihan_tanah" hidden id="kelebihan_tanah" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_angsur_kt" id="v_cicil_angsur_kt" disabled class="form-control">
                    <input type="text" name="cicil_angsur_kt" hidden id="cicil_angsur_kt" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_kt" id="tempo_kt" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Realisasi Bank (Rp)</label>
                    <input type="text" name="v_angsuran" id="v_angsuran" class="form-control">
                    <input type="text" name="angsuran" hidden id="angsuran" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_A" id="angsur_A" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_A" id="v_cicil_A" disabled class="form-control">
                    <input type="text" name="cicil_A" hidden id="cicil_A" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_A" id="tempo_A" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Piutang Bank (Rp)</label>
                    <input type="text" name="v_piutang" id="v_piutang" class="form-control">
                    <input type="text" name="piutang" hidden id="piutang" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_P" id="angsur_P" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_P" id="v_cicil_P" disabled class="form-control">
                    <input type="text" name="cicil_P" hidden id="cicil_P" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_P" id="tempo_P" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>PAK (Rp)</label>
                    <input type="text" name="v_pak" id="v_pak" class="form-control">
                    <input type="text" name="pak" hidden id="pak" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_pak" id="angsur_pak" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_angsur_pak" id="v_cicil_angsur_pak" disabled class="form-control">
                    <input type="text" name="cicil_angsur_pak" hidden id="cicil_angsur_pak" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_pak" id="tempo_pak" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="v_lain" id="v_lain" class="form-control">
                    <input type="text" hidden name="lain" id="lain" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_lain" id="angsur_lain" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_angsur_lain" id="v_cicil_angsur_lain" disabled class="form-control">
                    <input type="text" hidden name="cicil_angsur_lain" id="cicil_angsur_lain" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_lain" id="tempo_lain" class="form-control">
                </div>
            </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-sm" id="add-transaksi-bank"><i class="fa fa-save"></i> Simpan</button>
      </div>
    </div>
  </div>
</div>
...
<!-- Modal detail transaksi bank-->
<div class="modal fade" id="m-tf-bnk" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title text-light" id="exampleModalLabel">Detail Transaksi Bank</h5>
        <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>    
      <div class="modal-body table-responsive" id="tf-bnk">
  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title text-light" id="staticBackdropLabel">Edit Transaksi Bank</h5>
        <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="gaji" hidden id="gaji_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="gaji_p" hidden id="gaji_pe" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="harga" hidden id="harga_edit" class="form-control" disabled>
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-grup">
                    ...
                    <input type="text" name="hk_edit" hidden id="hk_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-grup">
                    ...
                    <input type="text" name="tj_edit" hidden id="tj_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-grup">
        ...
        <div class="row mt-2">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="tjl_edit" hidden id="tjl_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" disabled hidden name="angsuran_tjl_edit" id="angsuran_tjl_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
        ...
        <div class="row mt-2">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="um_edit" hidden id="um_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" disabled hidden name="angsuran_um_edit" id="angsuran_um_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
        ...
        <div class="row mt-2">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" name="kt_edit" hidden id="kt_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input type="text" disabled hidden name="angsuran_kt_edit" id="angsuran_kt_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Realisasi Bank (Rp)</label>
                    <input type="text" name="v_angsuran_edit" id="v_angsuran_edit" class="form-control">
                    <input type="text" hidden name="angsuran_edit" id="angsuran_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_AE" id="angsur_AE" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_AE" id="v_cicil_AE" disabled class="form-control">
                    <input type="text" hidden name="cicil_AE" id="cicil_AE" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_AE" id="tempo_AE" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Piutang Bank (Rp)</label>
                    <input type="text" name="v_piutang_edit" id="v_piutang_edit" class="form-control">
                    <input type="text" hidden name="piutang_edit" id="piutang_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_PE" id="angsur_PE" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" name="v_cicil_PE" id="v_cicil_PE" disabled class="form-control">
                    <input type="text" hidden name="cicil_PE" id="cicil_PE" disabled class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Dibayar Setiap Tanggal</label>
                    <input type="text" name="tempo_PE" id="tempo_PE" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>PAK (Rp)</label>
                    <input type="text" name="v_pak_edit" id="v_pak_edit" class="form-control">
                    <input type="text" hidden name="pak_edit" id="pak_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_pak_edit" id="angsur_pak_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" disabled name="v_angsuran_pak_edit" id="v_angsuran_pak_edit" class="form-control">
                    <input type="text" disabled hidden name="angsuran_pak_edit" id="angsuran_pak_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Di Bayar Setiap Tanggal</label>
                    <input type="text" name="bayar_pak_edit" id="bayar_pak_edit" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Lain-lain (Rp)</label>
                    <input type="text" name="v_lain_edit" id="v_lain_edit" class="form-control">
                    <input type="text" hidden name="lain_edit" id="lain_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Diangsur</label>
                    <input type="text" name="angsur_lain_edit" id="angsur_lain_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Cicilan Angsuran (Rp)</label>
                    <input type="text" disabled name="v_angsuran_lain_edit" id="v_angsuran_lain_edit" class="form-control">
                    <input type="text" disabled hidden name="angsuran_lain_edit" id="angsuran_lain_edit" class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>Di Bayar Setiap Tanggal</label>
                    <input type="text" name="bayar_lain_edit" id="bayar_lain_edit" class="form-control">
                </div>
            </div>
        </div>
